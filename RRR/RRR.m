...
%RRR MATLAB code file for RRR.fig
...
%
%      RRR('Property','Value',...) creates a new RRR using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to RRR_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      RRR('CALLBACK') and RRR('CALLBACK',hObject,...) call the
%      local function named CALLBACK in RRR.M with the given input
%      arguments.
%
...
% Last Modified by GUIDE v2.5 15-Jan-2019 13:17:50
